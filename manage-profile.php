...
<?php
    ...
    if (isset($_POST['update'])){
        ...
        $sql = mysqli_query( "UPDATE tbMembers SET first_name='$myFirstName', last_name='$myLastName', email='$myEmail', voter_id = '$myVoterid', password='$newpass' WHERE member_id = '$myId'" );
                //or die( mysqli_error() );
      ...
      <li class="one_half first">
        <blockquote>
            ...
            <tr>
                ...
                <td style="color:#000000"; ><?php echo $member_id; ?></td>
            </tr>
            <tr>
                <td style="color:#000000"; >First Name:</td>
                <td style="color:#000000"; ><?php echo $first_name; ?></td>
            </tr>
            <tr>
                <td style="color:#000000"; >Last Name:</td>
                <td style="color:#000000"; ><?php echo $last_name; ?></td>
            </tr>
            <tr>
