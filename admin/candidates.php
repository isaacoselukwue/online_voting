<?php
    ...
    $result= mysqli_query("SELECT * FROM tbCandidates");
...
<?php
    $positions_retrieved= mysqli_query("SELECT * FROM tbPositions");
    //or die("There are no records to display ... \n" . mysqli_error()); 
?>
...
if (isset($_POST['Submit']))
{
    ...
    $sql = mysqli_query( "INSERT INTO tbCandidates(candidate_name,candidate_position) VALUES ('$newCandidateName','$newCandidatePosition')" );
...
<?php
    ...
    // check if the 'id' variable is set in URL
     ...
     // delete the entry
     $result =  mysqli_query("DELETE FROM tbCandidates WHERE candidate_id='$id'")
